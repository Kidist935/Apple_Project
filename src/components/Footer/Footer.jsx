...
import { initializeFooterLinks } from '../../commonResource/js/style.js'
    ...
    <footer className="footer-wrapper">
		<div className="container"> 
			...
			<div className="footer-links-wrapper row"> 
				<div className="links-wrapper-1 col-sm-12 col-md col">
				...
				<div className="links-wrapper-2 col-sm-12 col-md col">
					<h3>Services</h3>
					<ul>
				...
				<div className="links-wrapper-3 col-sm-12 col-md col">
					<h3>Apple Store</h3>
					<ul>
				...
				<div className="links-wrapper-4 col-sm-12 col-md col">
					<h3>For Business</h3>
					<ul>
				...
				<div className="links-wrapper-5 col-sm-12 col-md col">
					<h3>Apple Values</h3>
					<ul>
						<li><a href="#">Find a Store</a></li>
						<li><a href="#">Genius Bar</a></li>
